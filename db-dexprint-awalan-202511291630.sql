...
CREATE TABLE `transaction_items` (
  ...
  `variant` enum('ICE','HOT') DEFAULT NULL,
...
CREATE TABLE `transactions` (
  ...
  `orderType` enum('dinein','takeaway','delivery') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Dump completed on 2025-11-29 16:30:45
